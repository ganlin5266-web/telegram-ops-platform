...
import {seedMode,SeedError} from './staging-seed.js';
import {seedStagingUsers} from './staging-users-seed.js';
...
try {
 ...
 console.log(JSON.stringify(await seedStagingUsers(db,apply)));
} catch(error) {
